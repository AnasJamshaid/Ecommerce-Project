...
export const Blog = () => {
  return (
    <div className="relative h-auto flex flex-col items-center justify-center bg-[#0D0D0D] mt-11 py-12">
      {/* Wrapper for the content */}
      <div className="w-full mx-auto px-16 lg:px-8 relative z-10 flex flex-col items-center text-center text-white mb-10">
        {/* Hero Content */}
        <h1 className="text-3xl font-great-vibes text-[#FF9F0D] mb-4">Blog Post</h1>
      ...
      <div className="flex flex-wrap justify-center gap-8">
        ...
        <div className="border-2 border-white rounded-lg overflow-hidden w-[300px]">
          ...
          <div className="p-5">
            ...
            <h3 className="text-xl font-semibold mb-4">Pellentesque Non Effictur Mi Aliquam</h3>
        ...
        <div className="border-2 border-white rounded-lg overflow-hidden w-[300px]">
          ...
          <div className="p-5">
            ...
            <h3 className="text-xl font-semibold mb-4">Curabitur rutrum velit ac congue malesuada</h3>
            <div className="flex justify-between items-center">
              <a href="#" className="text-white font-semibold">
                Learn More
              </a>

...
export const Whychoose = () => {
  return (
    <div className="relative h-auto flex flex-col bg-cover bg-center overflow-hidden bg-[#0D0D0D] mt-11">
      ...
      <div className="w-full mx-auto px-8 lg:px-4 relative z-10 flex flex-col lg:flex-row-reverse items-start justify-between">
        ...
        <div className="flex flex-col space-y-4 justify-center items-start text-white w-full lg:w-1/2 mt-28 lg:mb-0">
          <h1 className="text-3xl font-great-vibes text-[#FF9F0D]">
            Why Choose us
          </h1>
          <h2 className="text-4xl font-helvetica font-extrabold mb-6 text-white">
            <span className="text-[#FF9F0D]">Ex</span>traordinary taste
            <br />
            And Experienced
          </h2>
          <p className="text-[13px] font-inter font-light mb-6 max-w-screen-sm break-words">
          ...
          <div className="flex justify-between w-full lg:w-[50%] mt-8">
            ...
            <div className="flex flex-col items-center justify-center w-1/3">
              <p className="text-xs font-inter text-center mr-[28px]">
                Fast Food
              </p>
            </div>
            {/* Column 2 */}
            <div className="flex flex-col items-center justify-center w-1/3">
              <p className="text-xs font-inter text-center">Lunch</p>
            </div>
            {/* Column 3 */}
            <div className="flex flex-col items-center justify-center w-1/3">
              <p className="text-xs font-inter text-center ml-10">Dinner</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center shadow-lg mt-6">
            ...
            <div className="bg-white text-black text-lg font-medium py-3 px-5 rounded-r-lg flex items-center">
              ...
              <div className="flex flex-col items-start w-24 h-5 ml-5 mb-5">
                ...
                <span className="text-black text-base font-bold">Experience</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/3 flex items-start ml-32">
          <div className="grid grid-cols-1 gap-4">
            ...
            <Image
              src="/food10.png"
              alt="Image 6"
              className="w-[160px] h-40 ml-[340px] -mt-20 rounded-lg"
              width={500} // Specify width
              height={300} // Specify height
            />
          </div>

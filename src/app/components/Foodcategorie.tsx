...
export const Foodcategorie = () => {
  return (
    <div className="relative h-screen flex flex-col items-center justify-center bg-cover bg-center overflow-hidden bg-[#0D0D0D] mt-11">
      {/* Wrapper for the content */}
      <div className="w-full mx-auto px-16 lg:px-8 relative z-10 flex flex-col items-center text-center text-white mb-10">
        {/* Hero Content */}
        <h1 className="text-3xl font-great-vibes text-[#FF9F0D] mb-4">
          Food Category
        </h1>
      ...
      <div>
        ...
        <Image
          ...
          width={600}
          height={600}
          className="absolute left-[1420px] mt-[30px] transform -translate-x-1/2 -translate-y-1/2 rotate-[-60deg] opacity-30"
        />
      </div>
    </div>
  );

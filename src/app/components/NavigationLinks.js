  ...
  return (
    <ul className="flex space-x-7 relative">
      ...
      <li className="relative" onClick={() => handleLinkClick("home")}>
        <Link
          href="/"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "home" ? "text-[#FF9F0D]" : ""}`}
        >
          Home
        </Link>
      ...
      <li className="relative" onClick={() => handleLinkClick("menu")}>
        <Link
          href="/menu"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "menu" ? "text-[#FF9F0D]" : ""}`}
        >
          Menu
        </Link>
      </li>
      ...
      <li className="relative" onClick={() => handleLinkClick("blog")}>
        <Link
          href="/blog"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "blog" ? "text-[#FF9F0D]" : ""}`}
        >
          Blog
        </Link>
      </li>
      ...
      <li className="relative" onClick={() => handleLinkClick("pages")}>
        <Link
          href="/pages"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "pages" ? "text-[#FF9F0D]" : ""}`}
        >
          Pages
        </Link>
      </li>
      ...
      <li className="relative">
        <Link
          href="/about"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "about" ? "text-[#FF9F0D]" : ""}`}
        ...
        >
          <HiChevronDown
            className={`ml-12 -mt-5 transition-transform ${isAboutOpen ? "rotate-180" : ""}`}
          />
        </div>
        {isAboutOpen && (
          <ul
          ...
          >
            <li>
              <Link
                href="/about/ourstory"
                className="block hover:text-[#FF9F0D] py-2 px-4 transition duration-300 ease-in-out"
              >
                Our Story
              </Link>
            </li>
      ...
      <li className="relative" onClick={() => handleLinkClick("shop")}>
        <Link
          href="/shop"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "shop" ? "text-[#FF9F0D]" : ""}`}
        >
          Shop
        </Link>
      </li>
      ...
      <li className="relative" onClick={() => handleLinkClick("contact")}>
        <Link
          href="/contact"
          className={`text-white hover:text-[#FF9F0D] ${activeLink === "contact" ? "text-[#FF9F0D]" : ""}`}
        >
          Contact
        </Link>
      </li>
